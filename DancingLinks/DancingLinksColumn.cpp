...
void DancingLinksColumn::RemoveColumn()
{
  ...
  for(DancingLinksCell *ptr=dummycell_->down_ptr();
      ptr!=dummycell_;ptr=ptr->down_ptr())
  {
...
void DancingLinksColumn::UnremoveColumn()
{
  ...
  for(DancingLinksCell *ptr=dummycell_->up_ptr();
      ptr!=dummycell_;ptr=ptr->up_ptr())
  {
    for(DancingLinksCell *ptr2=ptr->left_ptr();
        ptr2!=ptr;ptr2=ptr2->left_ptr())
    {
      ptr2->UnremoveCell();
    }
  }
